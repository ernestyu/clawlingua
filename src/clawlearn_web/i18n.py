...
ZH_I18N = {
    ...
    "One-run override for CLAWLEARN_CLOZE_MIN_CHARS.": "\u4ec5\u672c\u6b21\u8fd0\u884c\u8986\u76d6 CLAWLEARN_CLOZE_MIN_CHARS\u3002",
    "Chunk max chars (override env)": "chunk \u6700\u5927\u5b57\u7b26\uff08\u8986\u76d6 env\uff09",
    "One-run override for CLAWLEARN_CHUNK_MAX_CHARS.": "\u4ec5\u672c\u6b21\u8fd0\u884c\u8986\u76d6 CLAWLEARN_CHUNK_MAX_CHARS\u3002",
