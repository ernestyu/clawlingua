...
def _config_values_from_view(cfg_view: dict[str, str]) -> tuple[str, ...]:
    return (
        ...
        cfg_view.get("CLAWLEARN_LINGUA_ANNOTATE_ENABLE", "false"),
        cfg_view.get("CLAWLEARN_LINGUA_ANNOTATE_BATCH_SIZE", "50"),
        cfg_view.get("CLAWLEARN_LINGUA_ANNOTATE_MAX_ITEMS", ""),
...
def on_load_defaults(
    ...
    *,
    ...
    return (
        ...
        dv("CLAWLEARN_LINGUA_ANNOTATE_ENABLE", lingua_annotate_enable_val),
        dv("CLAWLEARN_LINGUA_ANNOTATE_BATCH_SIZE", lingua_annotate_batch_size_val),
        dv("CLAWLEARN_LINGUA_ANNOTATE_MAX_ITEMS", lingua_annotate_max_items_val),
...
def on_save_config(
    ...
    *,
    ...
    updated = {
        ...
        "CLAWLEARN_LINGUA_ANNOTATE_ENABLE": lingua_annotate_enable_val or "",
        "CLAWLEARN_LINGUA_ANNOTATE_BATCH_SIZE": lingua_annotate_batch_size_val or "",
        "CLAWLEARN_LINGUA_ANNOTATE_MAX_ITEMS": lingua_annotate_max_items_val or "",
