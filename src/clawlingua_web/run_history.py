...
def build_env_snapshot(cfg: Any) -> dict[str, str]:
    return {
        "CLAWLINGUA_LLM_MODEL": as_str(getattr(cfg, "llm_model", "")),
        "CLAWLINGUA_TRANSLATE_LLM_MODEL": as_str(
            getattr(cfg, "translate_llm_model", "")
        ),
        "CLAWLINGUA_PROMPT_LANG": as_str(getattr(cfg, "prompt_lang", "")),
        "CLAWLINGUA_EXTRACT_PROMPT": as_str(getattr(cfg, "extract_prompt", "")),
        "CLAWLINGUA_EXPLAIN_PROMPT": as_str(getattr(cfg, "explain_prompt", "")),
        "CLAWLINGUA_MATERIAL_PROFILE": as_str(getattr(cfg, "material_profile", "")),
        "CLAWLINGUA_LEARNING_MODE": as_str(getattr(cfg, "learning_mode", "")),
    }
