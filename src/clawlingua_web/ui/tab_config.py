...
from clawlingua_web import handlers_config
    ...
    with gr.Tab(tr(initial_ui_lang, "Config", "閰嶇疆")) as config_tab:
        ...
        with gr.Accordion(
            ...
            validate_retry_enable_env = gr.Textbox(
                ...
                value=cfg_view.get("CLAWLINGUA_VALIDATE_FORMAT_RETRY_ENABLE", "true"),
            )
            ...
            validate_retry_llm_enable_env = gr.Textbox(
                ...
                value=cfg_view.get("CLAWLINGUA_VALIDATE_FORMAT_RETRY_LLM_ENABLE", "true"),
            )
