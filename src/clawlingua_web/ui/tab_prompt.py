...
from clawlingua_web import handlers_prompt

if TYPE_CHECKING:
    from clawlingua_web.ui.tab_config import ConfigTabComponents
    from clawlingua_web.ui.tab_run import RunTabComponents
